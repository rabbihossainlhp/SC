            ...
            <div>
              <label className="flex items-start gap-2 cursor-pointer">
                <input
                  ...
                  required
                  className="w-4 h-4 mt-0.5 rounded border-primary-500/30 bg-cyber-darker text-primary-600 focus:ring-primary-500"
                />
        ...
        <div className="bg-cyber-dark/50 backdrop-blur-sm border border-primary-500/20 rounded-2xl p-8 shadow-neon-green">
          ...
          {submitted ? (
            <div className="text-center space-y-4">
              <div className="w-20 h-20 mx-auto bg-accent-neon/10 border border-accent-neon/30 rounded-full flex items-center justify-center">
